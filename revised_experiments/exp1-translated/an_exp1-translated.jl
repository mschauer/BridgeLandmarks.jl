...
p_ms = Pars_ms(δmom=0.001, cinit=1., γinit=0.1, σobs = 0.01, covθprop = [0.01 0. 0.; 0.  0.01 0.; 0. 0.  0.01])
# for ahs adjust domain bounds
p_ahs = Pars_ahs(δmom=0.001, cinit=1.0, γinit=1.0/√n, db=[2.5,1.5],stdev=.25, σobs = 0.05, covθprop = [0.01 0. 0.; 0. 0.01 0.; 0. 0. 0.01])
#p_ahs = Pars_ahs(δmom=0.01, cinit=.02, γinit=1.0/√n, db=[2.5,1.5],stdev=.25, σobs = 0.01)
